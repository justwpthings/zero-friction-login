...
class ZFL_Admin_Settings {
    ...
    public function save_settings() {
        if (!isset($_POST['zfl_settings_nonce']) || !wp_verify_nonce($_POST['zfl_settings_nonce'], 'zfl_save_settings')) {
        ...
        $active_tab = isset($_POST['zfl_active_tab']) ? sanitize_text_field($_POST['zfl_active_tab']) : 'general';
    ...
    private function render_about_tab() {
        ?>
        <div class="zfl-about-wrapper" style="max-width: 1200px; margin-top: 20px;">
